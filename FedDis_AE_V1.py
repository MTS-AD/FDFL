...
if __name__ == '__main__':
    ...
    result_file_path = 'FedDis' + '_result.txt'
    for i in range(l_list):
        for j in range(1,5):
            p = 0.1+j*0.1
            print("Normal_label:--{} P--{}".format(i, p))
            auc,ap,total_time=DIS_LSTMAE_Perf(A_data,A_label, dataname, i, p)
            save_result(result_file_path, auc, ap, total_time, argsx.alg, 'FedDis', dataname, i, p)
